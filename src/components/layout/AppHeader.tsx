    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-background/80 backdrop-blur-xl px-6" dir={isArabic ? 'rtl' : 'ltr'}>
      ...
      <div className="flex items-center gap-3">
        ...
        <Button
          ...
          onClick={() => { if (window.location.pathname === '/projects') { window.dispatchEvent(new CustomEvent('open-create-project')); } else { navigate('/projects'); setTimeout(() => window.dispatchEvent(new CustomEvent('open-create-project')), 500); } }}
        >

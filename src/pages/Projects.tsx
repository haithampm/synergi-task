    ...
    <AppLayout>
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card className="rounded-3xl"><CardHeader className="pb-3"><CardDescription>Projects</CardDescription><CardTitle className="text-3xl">{projects.length}</CardTitle></CardHeader><CardContent className="text-sm text-muted-foreground">Portfolio records across the workspace.</CardContent></Card>
          <Card className="rounded-3xl"><CardHeader className="pb-3"><CardDescription>Tasks + Tickets</CardDescription><CardTitle className="text-3xl">{tasks.length + tickets.length}</CardTitle></CardHeader><CardContent className="text-sm text-muted-foreground">Inquiry data available for reporting and AI search.</CardContent></Card>

    ...
    <AppLayout>
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card className="rounded-3xl"><CardHeader className="pb-3"><CardDescription>Projects</CardDescription><CardTitle className="text-3xl"<CardTitle cl><Link to="/projects" className="hover:text-blue-600 hover:underline">{projects.length}</Link><assName="text-3xl font-bold"><Link to="/projects" className="hover:underline text-blue-600">{projects.length}</Link></CardTitle>/CardTitle></CardHeader><CardContent className="text-sm text-muted-foreground">Portfolio records across the workspace.</CardContent></Card>
